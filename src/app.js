...
function renderDeployCard(kind, mode, slotIndex) {
  ...
  card.appendChild(equipFieldLabel('Tier'));
  card.appendChild(el('div', { class: 'equip-writeup' }, item.tier || '—'));
  ...
  if (isAwakenMode) {
    ...
    if (item.star_effects) {
      ...
      card.appendChild(equipFieldLabel('Star Skill'));
